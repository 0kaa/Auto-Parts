...
@section('title', __('local.activities-types'))
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                                ...
                                <div class="content-header row">
                                    ...
                                    <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                                        <div class="form-group breadcrumb-right">
                                            ...
                                            <a href="{{route('admin.activities-types.create')}}" class="btn btn-icon hide-arrow btn-primary" >
                            ...
                            <div class="table-responsive">
                                <table class="table zero-configuration" id="activity-type-table">
                                    <thead>
                                    <tr>
                                        <th>@lang('local.id')</th>
                                    ...
                                    @foreach ($activities_types as $activity_type)
                                        ...
                                        <tr data-id="{{ $activity_type->id }}" class="row-with-img">
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{app()->isLocale('en')?$activity_type->name_en:$activity_type->name_ar}}</td>
                                            <td>
                                                <a
                                                   href="{{route('admin.activities-types.edit',  $activity_type->id)}}">
                                                ...
                                                @if($activity_type->name_en =='new spare parts'||$activity_type->name_en=='repair spare parts'||$activity_type->name_en=='tires'
                                               ||$activity_type->name_en =='car care'||$activity_type->name_en=='oils')
@else
                                                <a class="table-action-delete" data-user-id="{{$activity_type->id}}"
                                ...
                                <div id="delete-activity-type" class="modal fade">
                                    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                                        <div class="modal-content bd-0 tx-14">
                                            <div class="modal-header bg-danger pd-y-15 pd-x-25">
                                                <h6 class="tx-14 mg-b-0 header-title"><i
                                                            class="fa fa-trash mg-r-10"></i>@lang('modals.delete_title', ['title' => __('local.activities-types')])
                                                </h6>
                                            ...
                                            <form id="delete-activities-types-form">
                                                @csrf
                                                <div class="modal-body pd-25">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <p class="mg-b-10 tx-16 tx-gray tx-mont">@lang('modals.delete_all_descr', ['title' => __('local.activities-types')])</p>
    ...
    @push('js')
        ...
        <script type="text/javascript" src="{{ asset('admin/Forms/activity-type/index.js') }}"></script>
