...
@section('title', __('local.company-sectors'))
...
@section('content')
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                                ...
                                <div class="content-header row">
                                    <div class="content-header-left col-md-9 col-12 mb-2">
                                        <div class="row breadcrumbs-top">
                                            <div class="col-12">
                                                <h2 class="content-header-title float-left mb-0">@lang('local.company-sectors')</h2>
                                    ...
                                    <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                                        <div class="form-group breadcrumb-right">
                                            ...
                                            <a href="{{route('admin.company-sectors.create')}}" class="btn btn-icon hide-arrow btn-primary" >
                            ...
                            <div class="table-responsive">
                                <table class="table zero-configuration" id="company-sector-table">
                                    <thead>
                                    <tr>
                                        <th>@lang('local.id')</th>
                                    ...
                                    @foreach ($company_sectors as $company_sector)
                                        ...
                                        <tr data-id="{{ $company_sector->id }}" class="row-with-img">
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{app()->isLocale('en')?$company_sector->name_en:$company_sector->name_ar}}</td>
                                            <td>
                                                <a
                                                        href="{{route('admin.company-sectors.edit',  $company_sector->id)}}">
                                                ...
                                                <a class="table-action-delete" data-user-id="{{$company_sector->id}}"
                                ...
                                <div id="delete-company-sector" class="modal fade">
                                    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                                        <div class="modal-content bd-0 tx-14">
                                            <div class="modal-header bg-danger pd-y-15 pd-x-25">
                                                <h6 class="tx-14 mg-b-0 header-title"><i
                                                            class="fa fa-trash mg-r-10"></i>@lang('modals.delete_title', ['title' => __('local.company-sectors')])
                                                </h6>
                                            ...
                                            <form id="delete-company-sector-form">
                                                @csrf
                                                <div class="modal-body pd-25">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <p class="mg-b-10 tx-16 tx-gray tx-mont">@lang('modals.delete_all_descr', ['title' => __('local.company-sectors')])</p>
    ...
    @push('js')
        ...
        <script type="text/javascript" src="{{ URL::asset('admin/Forms/company-sector/index.js') }}"></script>
