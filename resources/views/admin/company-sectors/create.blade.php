...
@section('title',isset($company_sector)?trans('local.common_edit', ['field' =>__('local.company-sectors')]):trans('admin.add_new', ['field' =>__('local.company-sectors')]))
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body card-dashboard">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="breadcrumb-wrapper">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="breadcrumb-item active">@if(isset($company_sector))
                                                            @lang('local.common_edit', ['field' =>__('local.company-sectors')])
                                                        @else
                        ...
                        <form class="needs-validation" novalidate="" id="{{isset($company_sector)?'update-company-sector-form':'create-company-sector-form'}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="name_ar" class="form-control" placeholder=" @lang('local.name_ar')"
                                       aria-label=" @lang('local.name_ar')" value="{{isset($company_sector)?$company_sector->name_ar:''}}" aria-describedby="basic-addon-name" required="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="name_en" class="form-control" placeholder=" @lang('local.name_en')"
                                       aria-label=" @lang('local.name_en')" value="{{isset($company_sector)?$company_sector->name_en:''}}" aria-describedby="basic-addon-name" required="">
                                <div class="alert alert-danger mg-t-20" role="alert">
                                    <div class="d-flex align-items-center justify-content-start">
                                        <i class="icon ion-ios-close alert-icon tx-32"></i>
                                        <span></span>
