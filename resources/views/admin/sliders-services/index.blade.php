...
@section('title', __('local.our_services_gallery'))
...
@section('content')
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                                ...
                                <div class="content-header row">
                                    ...
                                    <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                                        <div class="form-group breadcrumb-right">
                                            ...
                                            <a href="{{route('admin.sliders-services.create')}}" class="btn btn-icon hide-arrow btn-primary" >
                            ...
                            <div class="table-responsive">
                                <table class="table zero-configuration" id="sliders-services-table">
                                    <thead>
                                    <tr>
                                        <th>@lang('loal.id')</th>
                                    ...
                                    @foreach ($slider_services as $slider_service)
                                        ...
                                        <tr data-id="{{ $slider_service->id }}" class="row-with-img">
                                            <td>{{ $loop->iteration }}</td>
                                            <td><img width="20%" height="20%" src="{{file_exists('storage/'.$slider_service->image)?asset('storage/'.$slider_service->image):asset('admin/images/img-upload-placeholder.jpg')}}"></td>
                                            <td>
                                                <a
                                                        href="{{route('admin.sliders-services.edit',  $slider_service->id)}}">
                                                ...
                                                <a class="table-action-delete" data-sub-id="{{$slider_service->id}}"
                                ...
                                <div id="delete-slider-service" class="modal fade">
                                    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                                        <div class="modal-content bd-0 tx-14">
                                            <div class="modal-header bg-danger pd-y-15 pd-x-25">
                                                <h6 class="tx-14 mg-b-0 header-title"><i
                                                            class="fa fa-trash mg-r-10"></i>@lang('modals.delete_title', ['title' => __('local.our_services_gallery')])
                                                </h6>
                                            ...
                                            <form id="delete-slider-service-form">
                                                @csrf
                                                <div class="modal-body pd-25">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <p class="mg-b-10 tx-16 tx-gray tx-mont">@lang('modals.delete_all_descr', ['title' => __('local.our_services_gallery')])</p>
    ...
    @push('js')
        ...
        <script type="text/javascript" src="{{ asset('admin/Forms/sliders-services/index.js') }}"></script>
