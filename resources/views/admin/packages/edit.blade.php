            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body card-dashboard">
                        ...
                        <form class="needs-validation" novalidate="" id="update-packages-form">
                            @csrf()
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="mg-b-20"> </p>
                                <div class="form-group">
                                    <img class="img-fluid" src="@if(isset($packages)&&$packages->badge!=""){{ file_exists('storage/'.$packages->badge)?asset('storage/'.$packages->badge ):(file_exists('website/'.$packages->badge)?asset('website/'.$packages->badge):asset('admin/images/img-upload-placeholder.jpg')) }}
