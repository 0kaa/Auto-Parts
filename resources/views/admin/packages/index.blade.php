...
@section('title', __('local.packages'))
...
@section('content')
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            ...
                            <div class="table-responsive">
                                <table class="table zero-configuration" id="package-table">
                                    <thead>
                                    <tr>
                                        <th>@lang('loal.id')</th>
                                    ...
                                    @foreach ($packages as $package)
                                        ...
                                        <tr data-id="{{ $package->id }}" class="row-with-img">
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{app()->isLocale('en')?$package->name_en:$package->name_ar}}</td>
                                            <td>
                                                ...
                                                <a class="table-action-delete" data-user-id="{{$package->id}}"
                                ...
                                <div id="delete-package" class="modal fade">
                                    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                                        <div class="modal-content bd-0 tx-14">
                                            <div class="modal-header bg-danger pd-y-15 pd-x-25">
                                                <h6 class="tx-14 mg-b-0 header-title"><i
                                                            class="fa fa-trash mg-r-10"></i>@lang('modals.delete_title', ['title' => __('local.package')])
                                                </h6>
                                            ...
                                            <form id="delete-package-form">
                                                ...
                                                <div class="modal-body pd-25">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <p class="mg-b-10 tx-16 tx-gray tx-mont">@lang('modals.delete_all_descr', ['title' => __('local.package')])</p>
    ...
    <script type="text/javascript" src="{{ asset('admin/Forms/packages/index.js') }}"></script>
