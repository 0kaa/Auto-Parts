            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body card-dashboard">
                        ...
                        <form class="needs-validation" novalidate="" method="post" id="{{isset($shippings)?'update-shippings-form':'create-shippings-form'}}">
                            @csrf()
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="shipping_name_ar" class="form-control" name="shipping_name_ar" placeholder=" @lang('admin.shipping_name_ar')" value="{{isset($shippings)?$shippings->shipping_name_ar:''}}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="shipping_name_en" class="form-control" name="shipping_name_en" placeholder=" @lang('admin.shipping_name_en')" value="{{isset($shippings)?$shippings->shipping_name_en:''}}"
