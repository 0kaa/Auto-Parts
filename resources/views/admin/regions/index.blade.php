...
@section('title', __('local.regions'))
...
@section('content')
                            ...
                            <div class="table-responsive">
                                <table class="table zero-configuration" id="region-table">
                                    ...
                                    @foreach ($regions as $region)
                                        ...
                                        <tr data-id="{{ $region->id }}" class="row-with-img">
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{app()->isLocale('en')?$region->name_en:$region->name_ar}}</td>
                                            <td>
                                                <a
                                                ...
                                                <a class="table-action-delete" data-user-id="{{$region->id}}"
                                ...
                                <div id="delete-region" class="modal fade">
                                    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                                        <div class="modal-content bd-0 tx-14">
                                            <div class="modal-header bg-danger pd-y-15 pd-x-25">
                                                <h6 class="tx-14 mg-b-0 header-title"><i
                                                            class="fa fa-trash mg-r-10"></i>@lang('modals.delete_title', ['title' => __('local.region')])
                                                </h6>
                                            ...
                                            <form id="delete-region-form">
                                                @csrf
                                                <div class="modal-body pd-25">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <p class="mg-b-10 tx-16 tx-gray tx-mont">@lang('modals.delete_all_descr', ['title' => __('local.region')])</p>
    ...
    @push('js')
        ...
        <script type="text/javascript" src="{{ asset('admin/Forms/region/index.js') }}"></script>
