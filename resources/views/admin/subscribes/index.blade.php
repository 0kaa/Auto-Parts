...
@section('title', __('local.news_letter'))
...
@section('content')
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                                ...
                                <div class="content-header row">
                                    <div class="content-header-left col-md-9 col-12 mb-2">
                                        <div class="row breadcrumbs-top">
                                            <div class="col-12">
                                                <h2 class="content-header-title float-left mb-0">@lang('local.news_letter')</h2>
                            ...
                            <div class="table-responsive">
                                <table class="table zero-configuration" id="sub-table">
                                    <thead>
                                    <tr>
                                        <th>@lang('loal.id')</th>
                                    ...
                                    @foreach ($subscribes as $subscribe)
                                        ...
                                        <tr data-id="{{ $subscribe->id }}" class="row-with-img">
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{$subscribe->email}}</td>
                                            <td>
                                                <a class="table-action-delete" data-sub-id="{{$subscribe->id}}"
                                ...
                                <div id="delete-subscribe" class="modal fade">
                                    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                                        <div class="modal-content bd-0 tx-14">
                                            <div class="modal-header bg-danger pd-y-15 pd-x-25">
                                                <h6 class="tx-14 mg-b-0 header-title"><i
                                                            class="fa fa-trash mg-r-10"></i>@lang('modals.delete_title', ['title' => __('local.news_letter')])
                                                </h6>
                                            ...
                                            <form id="delete-subscribe-form">
                                                @csrf
                                                <div class="modal-body pd-25">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <p class="mg-b-10 tx-16 tx-gray tx-mont">@lang('modals.delete_all_descr', ['title' => __('local.news_letter')])</p>
    ...
    @push('js')
        ...
        <script type="text/javascript" src="{{ asset('admin/Forms/subscribes/index.js') }}"></script>
