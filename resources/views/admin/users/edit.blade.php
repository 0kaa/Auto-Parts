                        ...
                        <form class="needs-validation" novalidate="" id="update-user-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="name" class="form-control" placeholder=" @lang('local.name')"
                                    aria-label=" @lang('local.name')" value="{{ isset($user) ? $user->name : '' }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" id="email" class="form-control"
                                    ...
                                    placeholder=" @lang('local.email')" aria-label=" @lang('local.email')"
                                    aria-describedby="basic-addon-name" required="">
                                <div class="alert alert-danger mg-t-20" role="alert">
                                    <div class="d-flex align-items-center justify-content-start">
                                        <i class="icon ion-ios-close alert-icon tx-32"></i>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="phone" class="form-control" placeholder=" @lang('local.phone')"
                                    value="{{ isset($user) ? $user->phone : '' }}" aria-label=" @lang('local.phone')"
                                    aria-describedby="basic-addon-name" required="">
                                <div class="alert alert-danger mg-t-20" role="alert">
                                    <div class="d-flex align-items-center justify-content-start">
                                        <i class="icon ion-ios-close alert-icon tx-32"></i>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" id="password" class="form-control" autocomplete="off"
                                    placeholder=" @lang('local.password')" aria-label=" @lang('local.password')"
                                    aria-describedby="basic-addon-name" required="">
                                <div class="alert alert-danger mg-t-20" role="alert">
                                    <div class="d-flex align-items-center justify-content-start">
                                        <i class="icon ion-ios-close alert-icon tx-32"></i>
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="mg-b-20"> </p>
                                <div class="form-group">
                                    <img src="@if (isset($user)) {{ file_exists('storage/' . $user->image)? asset('storage/' . $user->image): (file_exists($user->image)? asset($user->image): asset('admin/images/img-upload-placeholder.jpg')) }}
                                            @else
                                            {{ asset('admin/images/img-upload-placeholder.jpg') }} @endif"
                                        class="preview-img" width="100" height="100">
                            ...
                            <div class="form-group">
                                ...
                                <select id="type_user" class="form-control select2-show-search"
                                    ...
                                    <option value="user" {{ $user->roles[0]->name == 'user' ? 'selected' : '' }}>
                                        @lang('local.user')</option>
                                    <option value="owner_store"
                                        {{ $user->roles[0]->name == 'owner_store' ? 'selected' : '' }}>
                                        @lang('local.owner_store')</option>
                                    <option value="workshop" {{ $user->roles[0]->name == 'workshop' ? 'selected' : '' }}>
                                        @lang('local.workshop')</option>
                            ...
                            <div class="form-group">
                                ...
                                <select id="activity_type_id" class="form-control select2-show-search"
                                    placeholder=" @lang('local.activities-types')"
                                    aria-label=" @lang('local.activities-types')" aria-describedby="basic-addon-name"
                                    required="">

                                    @foreach ($activities_type as $activity_type)
                                        <option value="{{ $activity_type->id }}"
                                            {{ $activity_type->id == $user->activity_type_id ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="name_company" class="form-control"
                                    placeholder=" @lang('local.name_company')"
                                    value="{{ isset($user) ? $user->name_company : '' }}"
                                    aria-label=" @lang('local.name_company')" aria-describedby="basic-addon-name"
                                    required="">
                                <div class="alert alert-danger mg-t-20" role="alert">
                                    <div class="d-flex align-items-center justify-content-start">
                                        <i class="icon ion-ios-close alert-icon tx-32"></i>
                            ...
                            <div class="form-group">
                                ...
                                <label class="form-label" for="name_owner_company"> <span
                                        class="tx-danger">*</span>
                                    @lang('local.name_owner_company')</label>
                                <input type="text" id="name_owner_company" class="form-control"
                                    placeholder=" @lang('local.name_owner_company')"
                                    value="{{ isset($user) ? $user->name_owner_company : '' }}"
                                    aria-label=" @lang('local.name_owner_company')" aria-describedby="basic-addon-name"
                                    required="">
                                <div class="alert alert-danger mg-t-20" role="alert">
                                    <div class="d-flex align-items-center justify-content-start">
                                        <i class="icon ion-ios-close alert-icon tx-32"></i>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="national_identity" class="form-control"
                                    placeholder=" @lang('local.national_identity')"
                                    value="{{ isset($user) ? $user->national_identity : '' }}"
                                    aria-label=" @lang('local.national_identity')" aria-describedby="basic-addon-name"
                                    required="">
                                <div class="alert alert-danger mg-t-20" role="alert">
                                    <div class="d-flex align-items-center justify-content-start">
                                        <i class="icon ion-ios-close alert-icon tx-32"></i>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="date" class="form-control" placeholder=" @lang('local.date')"
                            ...
                            <div class="col-md-6">
                                <h5 class="tx-gray-800 mg-b-5">@lang('local.image_commercial_register'): <span
                                        class="tx-danger">*</span> </h5>
                                <p class="mg-b-20"> </p>
                                <div class="form-group">
                                    <img src="@if (isset($user)) {{ file_exists('storage/' . $user->file)? asset('storage/' . $user->file): (file_exists($user->file)? asset($user->file): asset('admin/images/img-upload-placeholder.jpg')) }}
                                            @else
                                            {{ asset('admin/images/img-upload-placeholder.jpg') }} @endif"
                                        class="preview-img" width="100" height="100">

                                    <label class="custom-file">
                                        <input type="file" id="file" class="form-control-file upload-img" />
                                        <span class="custom-file-control custom-file-control-primary">
                                        </span>
                                    </label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="ibn" class="form-control" placeholder=" @lang('local.ibn')"
                                    value="{{ isset($user) ? $user->ibn : '' }}" aria-label=" @lang('local.ibn')"
                                    aria-describedby="basic-addon-name" required="">
                                <div class="alert alert-danger mg-t-20" role="alert">
                                    <div class="d-flex align-items-center justify-content-start">
                                        <i class="icon ion-ios-close alert-icon tx-32"></i>
                                ...
                                <select id="region_id" class="form-control select2-show-search"
                                    ...
                                    @foreach ($regions as $region)
                                        <option value="{{ $region->id }}"
                                            ...
                                            {{ app()->isLocale('en') ? $region->name_en : $region->name_ar }}</option>
                                    @endforeach
                                </select>
                                ...
                                <select id="city_id" class="form-control select2-show-search"
                                    ...
                                    @foreach ($cities as $city)
                                        <option value="{{ $city->id }}"
                                            ...
                                            {{ app()->isLocale('en') ? $city->name_en : $city->name_ar }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <label class="form-label" for="is_company_facility_agent"> <span
                                        class="tx-danger">*</span>
                                    @lang('local.is_company_facility_agent')</label>
                                <select id="is_company_facility_agent" class="form-control select2-show-search"
                                    placeholder=" @lang('local.is_company_facility_agent')"
                                    aria-label=" @lang('local.is_company_facility_agent')"
                                    aria-describedby="basic-addon-name" required="">
                                    <option value="" readonly="" selected>@lang('admin.select')</option>
                                    <option value="yes"
                                        {{ $user->is_company_facility_agent == 'yes' ? 'selected' : '' }}>
                                        @lang('local.yes')</option>
                                    <option value="no" {{ $user->is_company_facility_agent == 'no' ? 'selected' : '' }}>
                                        @lang('local.no')</option>
                            ...
                            <div class="form-group">
                                ...
                                <label class="form-label" for="is_company_facility_authorized_distributor"> <span
                                        class="tx-danger">*</span>
                                    @lang('local.is_company_facility_authorized_distributor')</label>
                                <select id="is_company_facility_authorized_distributor"
                                    class="form-control select2-show-search"
                                    placeholder=" @lang('local.is_company_facility_authorized_distributor')"
                                    aria-label=" @lang('local.is_company_facility_authorized_distributor')"
                                    aria-describedby="basic-addon-name" required="">
                                    <option value="" readonly="" selected>@lang('admin.select')</option>
                                    <option value="yes"
                                        {{ $user->is_company_facility_authorized_distributor == 'yes' ? 'selected' : '' }}>
                                        @lang('local.yes')</option>
                                    <option value="no"
                                        {{ $user->is_company_facility_authorized_distributor == 'no' ? 'selected' : '' }}>
                                        @lang('local.no')</option>
                            ...
                            <div class="form-group">
                                ...
                                <label class="form-label" for="company_sector_id"> <span
                                        class="tx-danger">*</span>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="hidden" id="lng" name="lat" readonly="" class="form-control"
                                            required>
                                    </div>
