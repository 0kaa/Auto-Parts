...
@section('content')
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            ...
                            <div class="table-responsive">
                                <table class="table zero-configuration" id="cities-table">
                                    <thead>
                                    <tr>
                                        <th>@lang('local.id')</th>
                                    ...
                                    @foreach ($cities as $city)
                                        ...
                                        <tr data-id="{{ $city->id }}" class="row-with-img">
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{app()->isLocale('en')?$city->name_en:$city->name_ar}}</td>
                                            <td>
                                                <a
                                                ...
                                                <a class="table-action-delete" data-user-id="{{$city->id}}"
                                ...
                                <div id="delete-city" class="modal fade">
                                    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                                        <div class="modal-content bd-0 tx-14">
                                            <div class="modal-header bg-danger pd-y-15 pd-x-25">
                                                <h6 class="tx-14 mg-b-0 header-title"><i
                                                            class="fa fa-trash mg-r-10"></i>@lang('modals.delete_title', ['title' => __('local.city')])
                                                </h6>
                                            ...
                                            <form id="delete-city-form">
                                                ...
                                                <div class="modal-body pd-25">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <p class="mg-b-10 tx-16 tx-gray tx-mont">@lang('modals.delete_all_descr', ['title' => __('local.city')])</p>
    ...
    @push('js')
        ...
        <script type="text/javascript" src="{{ asset('admin/Forms/cities/index.js') }}"></script>
