...
@section('content')
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            ...
                            <div class="table-responsive">
                                <table class="table zero-configuration" id="product-table">
                                    <thead>
                                    <tr>
                                        <th>@lang('local.name')</th>
                                        <th>@lang('local.price')</th>
                                        <th>@lang('local.description')</th>
                                    ...
                                    @foreach ($products as $product)
                                        ...
                                        <tr data-id="{{ $product->id }}" class="row-with-img">
                                            <td>{{$product->name}}</td>
                                            <td>{{$product->price}}</td>
                                            ...
                                            <td>
                                                <a
                                                href="{{route('admin.products_edit',  $product->id)}}">
                                                ...
                                                <a class="table-action-delete" data-user-id="{{$product->id}}"
                                        ...
                                        <div class="modal-content bd-0 tx-14">
                                            <div class="modal-header bg-danger pd-y-15 pd-x-25">
                                                <h6 class="tx-14 mg-b-0 header-title"><i
                                                            class="fa fa-trash mg-r-10"></i>@lang('modals.delete_title', ['title' => __('local.product')])
                                                </h6>
                                            ...
                                            <form id="delete-product-form">
                                                ...
                                                <div class="modal-body pd-25">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <p class="mg-b-10 tx-16 tx-gray tx-mont">@lang('modals.delete_all_descr', ['title' => __('local.product')])</p>
    ...
    @push('js')
        <script src="{{ asset('admin/products/index.js') }}"></script>
    @endpush
