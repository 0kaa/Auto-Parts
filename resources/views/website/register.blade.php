...
@section('content_header')
    ...
    <div class="bannr_header" style="background-image: url({{ asset('website/images/banner.png') }});">
        <div class="caption">
            ...
            <p><a href="{{ route('website.home') }}"> {{ trans('local.home') }} </a> - <a href="#">
                    {{ trans('local.register') }} </a></p>
        </div>
    </div>
                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="form_sub-regester">
                                        ...
                                        <div class="input-sub-regester">
                                            <input type="text" class="form-control" name="username" id="username"
                                                placeholder="{{ __('local.Username (must be in English)') }}">
                                        ...
                                        <div class="input-sub-regester">
                                            <input type="text" class="form-control" id="first_name" name="first_name"
                                                placeholder="{{ __('local.first_name') }}">
                                            <div class="alert alert-danger mg-t-20" role="alert">
                                                <div class="d-flex align-items-center justify-content-start">
                                                    <i class="icon ion-ios-close alert-icon tx-32"></i>
                                                    <span></span>
                                        ...
                                        <div class="input-sub-regester">
                                            <input type="text" class="form-control" id="last_name" name="last_name"
                                                placeholder="{{ __('local.last_name') }}">
                                            <div class="alert alert-danger mg-t-20" role="alert">
                                                <div class="d-flex align-items-center justify-content-start">
                                                    <i class="icon ion-ios-close alert-icon tx-32"></i>
                                                    <span></span>
                                        ...
                                        <div class="input-sub-regester">
                                            <input type="password" class="form-control" id="confirm_password"
                                                name="confirm_password" placeholder="{{ __('local.confirm password') }}">
                                            <div class="alert alert-danger mg-t-20" role="alert">
                                                <div class="d-flex align-items-center justify-content-start">
                                                    <i class="icon ion-ios-close alert-icon tx-32"></i>
                                                    <span></span>
                                        ...
                                        <div class="btn-tab">
                                            <button type="submit" class="ctm-btn" id="send-code">
                                                {{ __('local.prev') }}</button>
                                        </div>
                                    </div>
                                </form>
                                <!-- end tap form 1 -->
                            ...
                            <div class="tab-pane" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <form action="#" id="comapny_register" onsubmit="return false">
                                    ...
                                    <div class="form_sub-regester">
                                        ...
                                        <div class="input-sub-regester">
                                            <select class="form-select form-control" id="get_type"
                                                data-action="{{ route('website.get.activity.types') }}" name="get_type"
                                                aria-label="Default select example" required>

                                                <option selected value="">{{ __('local.Activity type') }} </option>

                                                @foreach ($activities_types as $activities_type)
                                                    <option value="{{ $activities_type->id }}"
                                                        data-type="{{ $activities_type->type }}">
                                                        {{ $activities_type->name }} </option>
                                                @endforeach
                                        ...
                                        <div class="btn-tab">
                                            ...
                                            <button class="ctm-btn" id="done-register"> {{ __('local.prev') }}
                                            </button>
                            ...
                            <div class="tab-pane" id="messages" role="tabpanel" aria-labelledby="messages-tab">
                                <div class="done_register">
                                    ...
                                    <a href="{{ route('website.home') }}" class="ctm-btn">
                                        {{ __('local.Back to main') }} <i class="fas fa-arrow-left"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="" id="form-active-code" class="needs-validation" novalidate>
                        ...
                        <div class="register_sub_modal">
                            ...
                            <input type="number" name="code" id="code" class="form-control" required
                                placeholder="{{ __('local.verify_code') }}">
                            <div> {{ __('local.not_send_code') }} <a href="" id="resend_code"
                                    data-action="{{ route('website.resend.code') }}">{{ __('local.relpy_send') }}</a>
                            </div>

                            <button type="submit" class="ctm-btn" id="active-code">
                                {{ __('local.prev') }}</button>
                        </div>
