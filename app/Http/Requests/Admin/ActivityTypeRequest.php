...
class ActivityTypeRequest extends FormRequest
{
        ...
        switch($this->method())
        {
            ...
            case 'POST':
            {
                return [
                    ...
                    'num_pieces' => 'required|numeric|min:0',
                    'image' => 'required',
    ...
    public function messages()
    {
        return [
            ...
            'num_pieces.required' => __('errors.field_required', ['field' => __('local.num_pieces')]),
            'num_pieces.min' => __('errors.min', ['field' => __('local.num_pieces'),'value'=>0]),
            'num_pieces.numeric' => __('errors.numeric', ['field' => __('local.num_pieces')]),
